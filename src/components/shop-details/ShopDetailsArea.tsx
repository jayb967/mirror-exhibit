                ...
                <div className="tp-shop-details__tab-content-box mb-20">
                  <div className="tab-content" id="nav-tabContent">
                    ...
                    >
                      <div className="tp-shop-details__tab-big-img">
                        <img
                          src="assets/img/product/product-details-3.jpg"
                          alt=""
                        />
                      </div>
                    </div>
                    ...
                    >
                      <div className="tp-shop-details__tab-big-img">
                        <img
                          src="assets/img/product/product-details-4.jpg"
                          alt=""
                        />
                      </div>
                    </div>
                ...
                <div className="tp-shop-details__tab-btn-box">
                  <nav>
                    <div className="nav nav-tab" id="nav-tab" role="tablist">
                      ...
                      >
                        <img
                          src="assets/img/product/product-details-sm-4.png"
                          alt=""
                        />
                      </button>
                      <button
                      ...
                      >
                        <img
                          src="assets/img/product/product-details-sm-5.png"
                          alt=""
                        />
                      </button>
                      <button
                      ...
                      >
                        <img
                          src="assets/img/product/product-details-sm-6.png"
                          alt=""
                        />
                      </button>
                      <button
                      ...
                      >
                        <img
                          src="assets/img/product/product-details-sm-7.png"
                          alt=""
                        />
                      </button>
                    </div>
              ...
              <div className="tp-shop-details__right-warp">
                ...
                <div className="tp-shop-details__text-2">
                  <p>
                    ...
                    do eiusmod incididunt ut labore et dolore magna aliqua. Ut
                ...
                <div className="tp-shop-details__product-info">
                  <ul>
                    <li>
                      <span>color :</span>
                      <div className="tp-shop-details__variation-list">
                        <button
                          type="button"
                    ...
                    <li>
                      <span>Categories : </span>Tags clothing, e-commerce,
                      fashion
                    </li>
                    <li>
                      <span>Tags : </span>Black, Brown, Red, Shoes, £0.00 -
                      £150.00{" "}
                    </li>
                  </ul>
                </div>
                ...
                <div className="tp-shop-details__quantity-wrap mt-30 d-flex align-items-center">
                  ...
                  <div className="tp-shop-details__quantity-box">
                    <div className="tp-shop-details__quantity">
                      <div className="tp-cart-minus">
                        <i className="fal fa-minus"></i>
                      </div>
                      <input type="text" value="1" />
                      <div className="tp-cart-plus">
                            ...
                            <ul>
                              <li>
                                <div className="comments-box d-flex">
                                  <div className="comments-avatar mr-25">
                                    <img
                                      src="assets/img/product/client.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="comments-text">
                                    ...
                                    <p className="m-0">
                                      ...
                                      nunc, vitae ultricies erat elit eu lacus.
                                      Vestibulum non justo consectetur, cursus
                                      ante, tincidunt sapien. Nulla quis diam
                                      sit amet turpis interdum accumsan quis nec
                                      enim. Vivamus faucibus ex sed nibh egestas
                                      elementum. Mauris et bibendum dui. Aenean
                                      consequat pulvinar luctus. Suspendisse
                                      consectetur tristique tortor
                                    </p>
                                  </div>
                                </div>
                              ...
                              <li>
                                <div className="comments-box d-flex">
                                  <div className="comments-avatar mr-25">
                                    <img
                                      src="assets/img/product/client-2.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="comments-text">
                                    ...
                                    <p className="m-0">
                                      ...
                                      aliquet nunc, vitae ultricies erat elit eu
                                      lacus. Vestibulum non justo consectetur,
                                      cursus ante, tincidunt sapien. Nulla quis
                                      diam sit amet turpis interdum accumsan
                                      quis nec enim. Vivamus faucibus ex sed
                              ...
                              <li>
                                <div className="comments-box d-flex">
                                  <div className="comments-avatar mr-25">
                                    <img
                                      src="assets/img/product/client-3.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="comments-text">
                                    ...
                                    <p className="m-0">
                                      ...
                                      jewel buttons. I am  128lbs a 34A and
                                      the Small fit fine.
                                    </p>
                                  </div>
                                </div>
                            ...
                            <div className="accordion" id="accordionExample">
                              <div className="accordion-items tp-faq-active">
                                ...
                                >
                                  <div className="accordion-body">
                                    A G.xber has its own IP address, which is
                                    made public instead. While a rather
                                    seemingly insignificant change, the G.xber
                                    IP address can be used for a number of vital
                                    business to everything from security to
                                    customer experience.
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="accordion-items">
                                ...
                                >
                                  ...
                                  >
                                    How can we get the best from G.xber
                                    template?
                                  </button>
                                </h2>
                                <div
