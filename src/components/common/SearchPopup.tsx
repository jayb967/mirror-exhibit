...
const SearchPopup = ({ setShowSearch, showSearch }: any) => {
  ...
  return (
    <>
      <div className={`search__popup ${showSearch ? 'search-opened' : ''}`}>
              ...
              <div className="search__wrapper">
                <div className="search__top d-flex justify-content-between align-items-center">
                  ...
                  <div className="search__close">
                    <button type="button" className="search__close-btn search-close-btn" onClick={() => setShowSearch(false)}>
      ...
      <div className={`body-overlay ${showSearch ? "apply" : ""}`} onClick={() => setShowSearch(false)}></div>
