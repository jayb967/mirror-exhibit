...
const testimonial_content = {
  ...
  title: <>Discover the Art of <br /> Interior Transformation</>,
}
              ...
              <div className="tp-testimonial-2-thumb">
                <div className="tp-hover-distort-wrapper">
                  ...
                  <div className="tp-hover-distort" data-displacementimage="assets/img/webgl/10.jpg">
                    <img className="tp-hover-distort-img front" src="assets/img/testimonial/thumb-1-3.jpg" alt="image-here" />
                    <img className="tp-hover-distort-img back" src="assets/img/testimonial/thumb-1-3.jpg" alt="image-here" />
                  </div>
                </div>
              </div>
            </div>
