...
const ProductAreaHomeFour = () => {
  ...
  console.log('what is the products????', products)
            ...
            <div className="row align-items-end">
              ...
              <div className="col-xl-4 col-lg-4 col-md-5">
                <div className="tp-product-2-top-text">
                  <p>Explore our exclusive selection of bespoke mirrors.</p>
                </div>
              </div>
            </div>
          </div>
                        ...
                        <div className="tp-product-2-thumb-box p-relative">
                          <div className="tp-product-2-thumb fix p-relative">
                            <Image
                              ...
                              width={500}          // Define aspect ratio (e.g., 500x500 for a square)
                              height={500}         // Adjust to your actual image size or aspect ratio
