...
const slider_data: sliderDataType[] = [
  {
    bg_img: `assets/img/slider/Livingarea_Mirror_personaltrainer.webp`,
    subtitle: `Reflect`,
    title: `Your Luxury`,
    description: `Experience unparalleled elegance with bespoke laser-engraved mirrors for your home.`,
  },
  {
              ...
              <SwiperSlide key={i} className="swiper-slide">
                <div className="tp-slider-3-height p-relative fix grey-bg">
                  ...
                  <div className="tp-slider-3-social d-none d-xxl-block">
                    ...
                    <a target='_blank' href="https://www.instagram.com/mirrorexhibit/"><i className="fa-brands fa-instagram"></i></a>
